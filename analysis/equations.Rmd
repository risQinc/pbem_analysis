...
final_output <- final_output %>% 
                ...
                group_by(date) %>%
                mutate(model_output_nosl = nosl_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + nosl_30d*min(1, max(0, (thresh_10 - q_lt)/700)),   
                       model_output_action_2040 = action_2040_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + action_2040_30d*min(1, max(0, (thresh_10 - q_lt)/700)),
                       model_output_action_2060 = action_2060_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + action_2060_30d*min(1, max(0, (thresh_10 - q_lt)/700)),
                       model_output_action_2080 = action_2080_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + action_2080_30d*min(1, max(0, (thresh_10 - q_lt)/700)),
                       model_output_no_action_2040 = no_action_2040_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + no_action_2040_30d*min(1, max(0, (thresh_10 - q_lt)/700)),
                       model_output_no_action_2060 = no_action_2060_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + no_action_2060_30d*min(1, max(0, (thresh_10 - q_lt)/700)),
                       model_output_no_action_2080 = no_action_2080_10d*max(0, min(1, (q_lt - thresh_30)/ 700)) + no_action_2080_30d*min(1, max(0, (thresh_10 - q_lt)/700)),
                       ) %>%
  ungroup()
...
model_output = merge(final_output[, c('date', 'q_lt', 'model_output_nosl', 'model_output_action_2040', 'model_output_action_2060', 'model_output_action_2080', 'model_output_no_action_2040', 'model_output_no_action_2060', 'model_output_no_action_2080')], bfb[, c('date', 'mean_sc')])
```
...
ggplot()+
  ...
  geom_line(data = model_output, aes(x = date, y = model_output_action_2080, color = 'some_action_2080')) +
  geom_line(data = model_output, aes(x = date, y = model_output_no_action_2080, color = 'no_action_2080')) +
  xlab('Date') +
  ylab('SC Value')+
...
ggplot()+
  ...
  geom_line(data = drill_down, aes(x = date, y = model_output_nosl, color = 'no sea level rise')) +
  xlab('Date') +
  ylab('SC Value')+
